...
import EKAModel from "./pages/eka-model";
...
function Home() {
  return (
    <div>
      <h1>Executable Knowledge Architecture (EKA)</h1>

      <p>
        Turning enterprise architecture into executable, AI-ready knowledge systems.
      </p>

      <Link to="/pages/eka-model">Read: The EKA Model</Link>
    </div>
  );
}
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/eka-model" element={<EKAModel />} />
      </Routes>
    </BrowserRouter>
  );
}
